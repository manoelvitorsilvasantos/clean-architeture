...
import clientes.db.ClientesDAO;
...
public class Frmclientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton6ViaCEP = new javax.swing.JButton();
        ...
        jButton6ViaCEP.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jButton6ViaCEP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/correioscep.png"))); // NOI18N
        jButton6ViaCEP.setText("ViaCEP");
        jButton6ViaCEP.setEnabled(false);
        jButton6ViaCEP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ViaCEPActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jButton6ViaCEP, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void txtcepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcepKeyPressed
        ...
        //Ao pressionar a Tecla F1 no teclado será HABILITADO o Botão ViaCEP para efetuar a buca do
        //CEP usando o pacote br.com.parg.viacep, ou se preferir, somente dê um ENTER para a busca do
        //CEP através da classe WebServicecep.java
        }else if (evt.getKeyCode() == KeyEvent.VK_F1){
        jButton6ViaCEP.setEnabled(true);     
        }
    ...
    private void jButton6ViaCEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ViaCEPActionPerformed
      //Esse botão é HABILITADO quando o usuário estiver com o cursor posicionado no campo de CEP
      //e apertando a TECLA F1 no teclado.
        ViaCEP vc = new ViaCEP();
            Clientes obj = new Clientes();
            ClientesDAO dao = new ClientesDAO();
            try {
                vc.buscar(txtcep.getText());
                txtend.setText(vc.getLogradouro());
                txtbairro.setText(vc.getBairro());
                txtcidade.setText(vc.getLocalidade());
                cbuf.setSelectedItem(vc.getUf());
            } catch (ViaCEPException ex) {
                Logger.getLogger(Frmclientes.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null, "Ocorreu Erro Busca do CEP:  " +ex.getMessage());
            }

    }//GEN-LAST:event_jButton6ViaCEPActionPerformed
    ...
    private javax.swing.JButton jButton6ViaCEP;
